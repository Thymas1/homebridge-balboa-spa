 ...
 */
class PumpAccessory {
    constructor(platform, accessory, pumpNumber // 1-6 as defined by Balboa, 0 for circulation pump
    ) {
        var _a;
        ...
        this.service = (_a = this.accessory.getService(this.platform.Service.Fan)) !== null && _a !== void 0 ? _a : this.accessory.addService(this.platform.Service.Fan);
        ...
        this.service.getCharacteristic(this.platform.Characteristic.RotationSpeed)
            .on("set" /* CharacteristicEventTypes.SET */, this.setRotationSpeed.bind(this)) // SET - bind to the 'setRotationSpeed` method below
            .on("get" /* CharacteristicEventTypes.GET */, this.getRotationSpeed.bind(this)); // GET - bind to the 'getRotationSpeed` method below
    }
    /**
    ...
    setRotationSpeed(value, callback) {
        ...
        const speed = Math.round(value * this.numSpeedSettings / 100.0);
        // Store this immediately.
        this.lastNonZeroSpeed = speed;
        this.platform.log.debug('Set', this.name, 'Speed ->', value, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
    ...
    getRotationSpeed(callback) {
        if (!this.platform.isCurrentlyConnected()) {
            ...
            this.platform.log.debug('Get', this.name, 'Speed <-', value, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
            callback(null, value);
        }
    }
    ...
    updateCharacteristics() {
        ...
        if (this.numSpeedSettings) {
            this.platform.log.debug(this.name, 'updating to', isOn ? 'On' : 'Off', 'and', speed, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed));
    ...
    setSpeed(speed) {
        this.platform.log.debug(this.name, 'actually setting speed to', speed, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
...
exports.PumpAccessory = PumpAccessory;
//# sourceMappingURL=pumpAccessory.js.map