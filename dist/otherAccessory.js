 ...
 */
class OtherAccessory {
    constructor(platform, accessory, type // 0 = mister, 1 = aux1, 2 = aux2
    ) {
        var _a;
    ...
    setOn(value, callback) {
        ...
        if (this.type === 0) {
            ...
            this.platform.spa.setAuxState(this.type, value);
...
exports.OtherAccessory = OtherAccessory;
//# sourceMappingURL=otherAccessory.js.map