...
exports.WaterFlowProblemAccessory = void 0;
 ...
 */
class WaterFlowProblemAccessory {
    constructor(platform, accessory) {
        ...
        this.service = (_a = this.accessory.getService(this.platform.Service.LeakSensor)) !== null && _a !== void 0 ? _a : this.accessory.addService(this.platform.Service.LeakSensor);
        ...
        this.service.getCharacteristic(this.platform.Characteristic.LeakDetected)
            .on("get" /* CharacteristicEventTypes.GET */, this.handleLeakDetectedGet.bind(this));
        this.service.getCharacteristic(this.platform.Characteristic.StatusFault)
            .on("get" /* CharacteristicEventTypes.GET */, this.handleFaultDetectedGet.bind(this));
    }
    handleLeakDetectedGet(callback) {
        if (!this.platform.isCurrentlyConnected()) {
            ...
            callback(null, flowState === spaClient_1.FLOW_FAILED);
        }
    }
    handleFaultDetectedGet(callback) {
        if (!this.platform.isCurrentlyConnected()) {
            callback(this.platform.connectionProblem);
        }
        else {
            ...
            callback(null, flowState === spaClient_1.FLOW_LOW);
        }
    }
    ...
    updateCharacteristics() {
        ...
        const flowState = this.platform.spa.getFlowState();
        this.service.getCharacteristic(this.platform.Characteristic.LeakDetected).updateValue(flowState === spaClient_1.FLOW_FAILED);
        this.service.getCharacteristic(this.platform.Characteristic.StatusFault).updateValue(flowState === spaClient_1.FLOW_LOW);
    }
}
exports.WaterFlowProblemAccessory = WaterFlowProblemAccessory;
//# sourceMappingURL=waterFlowProblemAccessory.js.map