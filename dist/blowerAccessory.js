...
class BlowerAccessory {
    ...
    setRotationSpeed(value, callback) {
        ...
        this.platform.log.debug('Set Blower Speed ->', value, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
    ...
    getRotationSpeed(callback) {
        if (!this.platform.isCurrentlyConnected()) {
            ...
            this.platform.log.debug('Get Blower Speed <-', value, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
            callback(null, value);
        }
    }
    ...
    updateCharacteristics() {
        ...
        this.platform.log.debug('Blower updating to', isOn ? 'On' : 'Off', 'and', speed, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed));
    ...
    setSpeed(speed) {
        this.platform.log.debug('Blower actually setting speed to', speed, 'which is', spaClient_1.SpaClient.getSpeedAsString(this.numSpeedSettings, speed), this.platform.status());
...
exports.BlowerAccessory = BlowerAccessory;
//# sourceMappingURL=blowerAccessory.js.map